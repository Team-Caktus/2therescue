...
class Applicant(models.Model):
    ...
    current_residence = models.TextField(choices=current_residence, default='house' )
    ...
    adopt_reason = models.TextField(choices= adopt_reason, default='companion', blank=True)
